...
def main():
	...
	den1 = Dense(128, activation = 'relu', name = 'fc1')(concat)
	dout1 = Dropout(0.3)(den1)
	den2 = Dense(64, activation = 'relu', name = 'fc2')(dout1)
	dout2 = Dropout(0.3)(den2)
	den3 = Dense(32, activation = 'relu', name = 'fc3')(dout2)
	den4 = Dense(1, activation = 'relu', name = 'fc4')(den3)

	model = Model([user_input, book_input], den4)
	model.compile(optimizer = 'adam', loss = 'mean_squared_error')
	history = model.fit([train.user_id, train.book_id], train.rating, epochs = 10, verbose = 1)
	model.save('book_recommendation_trained_model_NN.h5')
